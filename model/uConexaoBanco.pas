...
{                            <----- INSERIR ARQUIVO .INI NA PASTA DO EXECUTÁVEL DO PROJETO ----->,
 Vitor Daniel - 10/12/2021 - implementação paliativa do arquivo que seta as informaçoes para a conexão,
 mudanças para no quando for usado um instalador, criar pastas específicas na instalação, ou criar uma arquitetura de conexão com banco de dados via serviço}
