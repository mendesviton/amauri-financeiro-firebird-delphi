inherited frCon_usuario: TfrCon_usuario
  ...
  inherited pnBarra: TPanel
    Width = 1111
    ExplicitWidth = 1111
    inherited spImprimir: TSpeedButton
      Left = 99
  ...
  inherited DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'BDDATAINSERCAO'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Courier New'
        Font.Style = []
        Title.Caption = 'Data de inser'#231#227'o'
        Title.Font.Charset = ANSI_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -13
        Title.Font.Name = 'Courier New'
  ...
  inherited cliDS1: TClientDataSet
    ProviderName = 'DSPRO1'
  end
  object PopupMenu1: TPopupMenu
    ...
    object irarSeleotodos1: TMenuItem
      Caption = 'Tirar sele'#231#227'o todos'
    end
  end
end
